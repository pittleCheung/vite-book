...
1.  然后我们正式开始实现`依赖预构建`的功能，通过 Esbuild 实现依赖扫描和依赖构建的功能。
1.  接着开始搭建 Vite 的插件机制，也就是开发  `PluginContainer`  和  `PluginContext`  两个主要的对象。
1.  搭建完插件机制之后，我们将会开发一系列的插件来实现 no-bundle 服务的编译构建能力，包括入口 HTML 处理、 TS/TSX/JS/TSX 编译、CSS 编译和静态资源处理。
1.  最后，我们会实现一套系统化的模块热更新的能力，从搭建模块依赖图开始，逐步实现 HMR 服务端和客户端的开发。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/54d6fa88b5e449a7bb7ef0a8ccecf384~tplv-k3u1fbpfcp-zoom-1.image)
...
如此一来，我们就可以在业务项目中使用  `mini-vite`  这个命令了。在小册的 Github 仓库中我为你准备了一个示例的  `playground`  项目，你可以拿来进行测试，[点击查看项目](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fsanyuan0704%2Fjuejin-book-vite%2Ftree%2Fmain%2Fmini-vite%2Fplayground "https://github.com/sanyuan0704/juejin-book-vite/tree/main/mini-vite/playground")。
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/54b07a0f4c5544789300170090408cb5~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d41b1bbf5ae94f79b00e511244cb5f14~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f0c58038810d403c921d74f5616f03dc~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/466b1687e4ee4d729a8a24689300a61e~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a43949e327a9403b8f9c3c13a7c73ffe~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8606700590cb4fc2ab25a18369024d9e~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/529ddf5e5e07431880048e0d0c494b26~tplv-k3u1fbpfcp-zoom-1.image)

同时，页面内容也能被渲染出来了:

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/00b16669320c4d089c4bc2e24828cbb7~tplv-k3u1fbpfcp-zoom-1.image)
